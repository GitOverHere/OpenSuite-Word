...
public function __construct($id=NULL){
	...
	$this->q = shell_exec("curl -H ".'"'."Authorization: Bearer $this->token->Get()".'"'. "-H". "Client-ID: j4yo5sixp9f5kldggrr7ryml91uv1c".' https://api.twitch.tv/helix/users/subscribers?to_id=$this->token->$user_id');
