...
public function __construct($id=null) {
	...
	$this->q = shell_exec("curl -H ".'"'."Authorization: Bearer $this->token->Get()".'"'. "-H". "Client-ID: j4yo5sixp9f5kldggrr7ryml91uv1c".' https://api.twitch.tv/helix/hypetrain/event?to_id=$this->token->$user_id');
