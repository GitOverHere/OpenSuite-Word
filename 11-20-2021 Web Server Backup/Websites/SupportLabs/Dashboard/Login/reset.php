...
echo "If that is a valid email, you will recieve a password reset email.";
if($user->email_valid($email)){
	
	$hash = Hasher::random(12); 
	$user->reset_password($_POST['email'],$hash);
	...
	mail($_POST['email'],"SuppportLabs Password Reset",$content,"from: reset@sahu.me");
}
